return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			keymap.set("n", "gD", vim.lsp.buf.implementation, { desc = "" })
			keymap.set("n", "gr", telescope.lsp_references, { desc = "" })
			keymap.set("n", "gr", vim.lsp.buf.references, { desc = "" })
			...
			keymap.set("n", "]d", vim.diagnostic.goto_prev, { desc = "" })
			...
			keymap.set("n", "<leader>ca", vim.lsp.buf.code_action, { desc = "" })
			keymap.set("n", "<leader>rn", vim.lsp.buf.rename, { desc = "" })
			keymap.set("n", "<leader>H", vim.lsp.buf.signature_help, { desc = "" })
